...
const ApplicationTile = (props) => {
  ...
  const getResume = () => {
    const resumeUrl = application.jobApplicant.resume;
    if (resumeUrl && resumeUrl !== "") {
      axios
        ...
        .then((response) => {
          ...
          // Optionally, name the file using the applicant's name or a static name.
          link.download = `resume_${application.jobApplicant.name}.jpg`;
  ...
  const handlePay = async () => {
    ...
    // For demo purposes, we use a fixed amount.
    // In production, you should call your backend to create a Razorpay order.
    const options = {
      key: "rzp_test_YEkxajE93bN5iJ", // Your Razorpay Key Id
      amount: "100000", // Amount in paise: INR 100.00
      currency: "INR",
      name: "Workify Payment",
      description: "Payment for job application",
      // Optionally, set a logo image:
      ...
      notes: {
        address: "Workify Corporate Office",
      },
      theme: {
        color: "#3399cc",
      },
